...
if(isset($_POST))
{
 ...
 $sql .="create table $bname(id int auto_increment,part varchar(50),amount varchar(50),primary key(id)); create table $dname(id int auto_increment,title varchar(50),notes varchar(50),date varchar(50),category varchar(50), primary key(id))";

 // $sql .="create table $dname(id int auto_increment,title varchar(50),notes varchar(50),date varchar(50),category varchar(50), primary key(id))";
